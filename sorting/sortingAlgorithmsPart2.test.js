...
describe('Part 2', function() {
  ...
  describe('#merge', function() {
    ...
    let merge = require('./sortingAlgorithmsPart2').merge;
  ...
  describe('#mergeSort', function() {
    ...
    let mergeSort = require('./sortingAlgorithmsPart2').mergeSort;
  ...
  //
  //   let partition = require('./sortingAlgorithmsPart2.js').partition;
  //   let arr = [];
  //
  //   beforeEach(function() {
  //     arr = [6, 5, 3, 1, 8, 7, 2, 4];
 ...
 // console.log('hi');
  describe('#quickSort', function() {
    ...
    let quickSort = require('./sortingAlgorithmsPart2.js').quickSort;
